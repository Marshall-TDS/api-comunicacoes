...
Este tutorial explica como configurar o Nginx como proxy reverso para a API de Comunicações com certificado SSL usando Let's Encrypt (Certbot).
...
- **Homologação**: `https://homolog-api-comunicacoes.marshalltds.com` → Porta `5334`
- **Produção**: `https://api-comunicacoes.marshalltds.com` → Porta `3334`
...
```bash
# Para homologação
docker-compose ps api-comunicacoes-homolog

# Para produção
docker-compose ps api-comunicacoes-main

# Se não estiver rodando, inicie:
docker-compose up -d api-comunicacoes-homolog
# ou
docker-compose up -d api-comunicacoes-main
```
...
```bash
# Homologação
curl https://homolog-api-comunicacoes.marshalltds.com/api/health

# Produção
curl https://api-comunicacoes.marshalltds.com/api/health
```
...
```bash
# Logs de acesso
sudo tail -f /var/log/nginx/homolog-api-comunicacoes.marshalltds.com-access.log

# Logs de erro
sudo tail -f /var/log/nginx/homolog-api-comunicacoes.marshalltds.com-error.log
```
...
sudo cat /etc/nginx/sites-available/homolog-api-comunicacoes.marshalltds.com
...
- Verifique os logs: `docker-compose logs api-comunicacoes-homolog`
- Teste a porta diretamente: `curl http://localhost:5334/api/health`

### Erro: "DNS não está configurado"

- Verifique o DNS: `nslookup homolog-api-comunicacoes.marshalltds.com`
...
- Verifique se o DNS está propagado: `dig +short homolog-api-comunicacoes.marshalltds.com`
...
```
/etc/nginx/sites-available/homolog-api-comunicacoes.marshalltds.com
/etc/nginx/sites-enabled/homolog-api-comunicacoes.marshalltds.com -> (link simbólico)
/var/log/nginx/homolog-api-comunicacoes.marshalltds.com-access.log
/var/log/nginx/homolog-api-comunicacoes.marshalltds.com-error.log
/etc/letsencrypt/live/homolog-api-comunicacoes.marshalltds.com/ (certificados SSL)
```
...
- **Homologação**: `https://homolog-api-comunicacoes.marshalltds.com`
- **Produção**: `https://api-comunicacoes.marshalltds.com`
